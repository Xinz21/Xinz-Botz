...
let mssgg = {
        ...
        mods: '\n> ꜱᴏʀʀy ᴄᴏᴍᴍᴀɴᴅ ᴛᴛᴜ ʜᴀɴyᴀ ʙɪꜱᴀ ᴅɪɢᴜɴᴀᴋᴀɴ ᴏʟᴇʜ *ᴍᴏᴅᴇʀᴀᴛᴏʀ ʙᴏᴛ'}[type]

        if (mssgg) return conn.sendMessage(m.chat, {
      text: mssgg, 
      contextInfo: {
          mentionedJid: conn.parseMention(mssgg),
...
let msgg = {
  ...
  if (msgg) return conn.sendMessage(m.chat, {
      text: msgg, 
      contextInfo: {
          mentionedJid: conn.parseMention(msgg),
...
"120363240926353589@newsletter",
        ...
        newsletterName: `Click Burton Here`,
...
▰▱▰▱▰▱▰▱▰▱▰▱`}[type]
  ...
  if (daftar) return conn.sendMessage(m.chat, {
      text: daftar, 
      contextInfo: {
          mentionedJid: conn.parseMention(daftar),
